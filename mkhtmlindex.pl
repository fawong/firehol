...
if (@ARGV != 2) {
  print STDERR "Usage: mkhtmlindex.pl output.html firehol-script\n";
  exit 1;
}
...
<head>
  ...
  <title>FireHOL Service Index</title>
  <link href="firehol-manual.css" type="text/css" rel="stylesheet"></link>
</head>
<body>
  <h2>FireHOL Service Index</h2>
  <table width="80%">
!
;
...
sub format_entries {
  ...
  foreach my $k (@use) {
    print O "        <a href=\"firehol-manual.html#service-$k\">$k</a>\n";
  }
}
